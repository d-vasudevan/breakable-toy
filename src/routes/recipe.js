...
function IngredientItem(props) {
  const listItems = props.ingredients.map(ingredient => 
    <li key={ingredient.ingredient_name} className='justify-self-center text-center'>
      <img src={ingredient.ingredient_img} alt={ingredient.ingredient_name} className='object-cover rounded-full w-20 h-20 md:w-24 md:h-24 mb-2'></img>
            ...
            <div className='grid md:grid-rows-1 md:grid-cols-3 w-full gap-x-16'>
              ...
              <div className='md:col-span-2'>
                <div className='mt-5 md:mt-0 mb-10'>
                  ...
                  <ul className='grid grid-cols-3 lg:grid-cols-5 gap-x-10 gap-y-5'><IngredientItem ingredients={recipe.ingredients}></IngredientItem></ul>
                </div>
                <div className='mb-5'>
